  ...
  return (
    <div>
      <header className="mb-10">
        <h1 className="text-3xl font-semibold text-black tracking-tight">OtherData</h1>
        <p className="text-[15px] text-zinc-500 mt-1.5">Manage your OtherData here.</p>
      </header>
